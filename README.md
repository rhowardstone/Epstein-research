...
| [MAXWELL_ARRANGED_WOMEN_POWERFUL_MEN](individuals/MAXWELL_ARRANGED_WOMEN_POWERFUL_MEN.md) | **NEW:** Emails recovered from Epstein's seized hard drives show Maxwell arranging access to women for influential men beyond Epstein — including Prince Andrew (Duke of York) and Clinton aide Doug Band. Prosecutors assembled them as trial exhibits; Judge Nathan excluded every one before the jury saw them. The FBI's sworn interpretations, SDNY's explicit identification of both men by name, and the full chain of custody survive in the public court record. Includes executive summary + full primary source record with verified EFTA citations. |
