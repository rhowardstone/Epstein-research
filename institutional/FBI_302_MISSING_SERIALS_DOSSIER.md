...
**[EFTA00016612](https://www.justice.gov/epstein/files/DataSet%208/EFTA00016612.pdf)** (Dataset 8, 4 pages)
...
**[EFTA00095751](https://www.justice.gov/epstein/files/DataSet%209/EFTA00095751.pdf)** (Dataset 9, 63 pages)
...
**[EFTA01684300](https://www.justice.gov/epstein/files/DataSet%2010/EFTA01684300.pdf)** (Dataset 10, 166 pages)
...
|-------------|-------|---------|------------|
| [EFTA01245620](https://www.justice.gov/epstein/files/DataSet%209/EFTA01245620.pdf) | 9 | FD-302 — Interview One, dated 07/24/2019, Serial 216 | 3501.045-001 |
| [EFTA01245629](https://www.justice.gov/epstein/files/DataSet%209/EFTA01245629.pdf) | 1 | Photograph, CONFIDENTIAL | 3501.045-008 |
| [EFTA01245630](https://www.justice.gov/epstein/files/DataSet%209/EFTA01245630.pdf) | 1 | Photograph, CONFIDENTIAL | 3501.045-009 |
| [EFTA01245631](https://www.justice.gov/epstein/files/DataSet%209/EFTA01245631.pdf) | 1 | Photograph, CONFIDENTIAL | 3501.045-010 |
| [EFTA01245632](https://www.justice.gov/epstein/files/DataSet%209/EFTA01245632.pdf) | 1 | FBI Crisis Intake, dated 07/31/2019, Serial 195 | 3501.045-011 |
| [EFTA01245633](https://www.justice.gov/epstein/files/DataSet%209/EFTA01245633.pdf) | 2 | FBI EC — attorney contact with FBI, dated 11/13/2019, Serial 320 | 3501.045-012 |
| [EFTA01245635](https://www.justice.gov/epstein/files/DataSet%209/EFTA01245635.pdf) | 2 | FBI EC — provide info to Seattle FO, dated 07/19/2019, Serial 159 | 3501.045-013 |
...
| Other/Unknown | various | 193 |

### Distribution by Dataset

| Dataset | Documents | Pages |
|---------|-----------|-------|
| DS8 | 5 | 8 |
| DS9 | 379 | 3,105 |
| DS10 | 31 | 478 |
...
1. Each serial can have multiple sub-records (e.g., 3501.045 has 4 FD-302s)
2. The 419 count includes 302s from multiple investigations (MCC death, Palm Beach, SDNY)
3. The 136-serial list appears to cover only the SDNY sex trafficking prosecution interviews
...
**Example**: For 3501.045, we manually verified 15 sub-records on page 7 of the disclosure index. The automated parser found only 3 sub-serials due to OCR errors. This means the programmatic "expected" counts are **severe undercounts** and cannot be relied upon for gap calculation.
...
3. A dedicated OCR pass with a more capable engine than Tesseract
...
1. **FD-302 Interview Reports**: The core product of FBI interviews — the detailed written summaries of what witnesses and victims told the FBI. These are the most consequential missing documents.

2. **Interview Notes**: The raw handwritten or typed notes agents took during interviews. These sometimes contain details not in the formal 302.

3. **Supporting Records**: Law enforcement reports, licenses, photographs, audio recordings, and other materials attached to each interview serial.
...
1. **Better OCR of EFTA00095751**: The justice.gov PDF is available. A dedicated OCR pass (or manual transcription of the 63 pages) would allow a complete accounting of every expected sub-record
2. **Deep-dive additional serials**: Replicate the 3501.045 manual audit for the largest serials (3501.226, 3501.103, 3501.162, 3501.055) to establish the gap rate across multiple interview files
3. **Cross-reference CHS intelligence reports**: The master serial log references confidential human source reports on topics including Israeli foreign influence, Chabad, Masha Drokova, and classified Epstein material — are any of these in the published files?
4. **FOIA request**: The disclosure index provides specific serial numbers and dates that can be cited in a targeted FOIA request for the missing 302s
5. **Congressional inquiry**: The interview index (EFTA00016612) and disclosure index (EFTA00095751) together constitute a roadmap for oversight — the government's own records documenting what should exist

---

## See Also

- **[The Hidden Numbering System: Secondary Bates Stamps](SECONDARY_BATES_STAMP_ANALYSIS.md)** — How the production was assembled from multiple document streams, and quantitative evidence that 57-75% of reviewed pages were withheld. The `3501.xxx` serials analyzed here are System 6 in that report.
- **[Corpus Inventory](../methodology/CORPUS_INVENTORY.md)** — Complete evidence chain for the EFTA production.
