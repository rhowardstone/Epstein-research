...
1. **EFTA_R1_** (FBI device extractions, DS10/DS11): 2.21 million pages reviewed, 970,000 released (42.6%), **1.27 million withheld (57.4%)**
2. **EFTA_** (SDNY production sequence, DS9/DS10): 269,394 pages reviewed, 67,493 released (25.1%), **201,901 withheld (74.9%)**

Combined, the two trackable systems reveal **1.47 million pages** that were reviewed and stamped but not included in the public production.
...
**968,304 pages across 645,986 documents in DS10/DS11**
...
**Distribution:** DS10 (323,563 docs) and DS11 (328,238 docs). DS11 is 98.9% R1-stamped material.
...
| Pages withheld (gaps in R1 sequence) | 1,271,798 |
| Withholding rate | 57.4% |
| Number of separate gaps | 242,390 |
| Largest single gap | 19,937 consecutive pages |

The 242,390 gaps break down as:

| Gap size | Number of gaps | Total missing pages |
|----------|---------------|-------------------|
| 1-5 pages | 194,738 | 411,576 |
| 6-20 pages | 41,461 | 392,764 |
| 21-100 pages | 5,345 | 197,582 |
| 101-500 pages | 783 | 140,718 |
| 501-2,000 pages | 45 | 39,947 |
...
**79,419 pages across 10,292 documents in DS9/DS10/DS11/DS12**

A separate system from R1. Pages carry a stamp in the format `EFTA_00057769` (underscore, no "R1" prefix). This numbering begins at `EFTA_00000001`, which appears on a Bureau of Prisons commissary receipt from MCC New York (EFTA00134541). It is the literal first page of the SDNY production.
...
**Distribution:** DS9 (16,050 pages), DS10 (50,721 pages), DS11 (1,334 pages), DS12 (191 pages).
...
**50,319 pages across ~49,000 documents in DS10**
...
**Location:** DS10 only, concentrated in the EFTA 1,299,930 to 1,656,686 range. 92.6% of these documents also carry SDNY_GM stamps.

### System 4: DB-SDNY- (Deutsche Bank Records)

**68,041 pages across ~54,000 documents in DS10**
...
**Location:** DS10 only, concentrated in the EFTA 1,282,009 to 1,462,305 range. Most also carry SDNY_GM stamps.

### System 5: SDNY_GM (Maxwell Case Stamps)

**185,165 pages across ~120,000 documents**
...
Unlike the other systems, SDNY_GM frequently appears alongside bank stamps. 45,606 documents carry both JPM-SDNY and SDNY_GM stamps. 56,641 carry both DB-SDNY and SDNY_GM stamps. Only ~17,500 documents carry SDNY_GM as their sole secondary stamp; these represent the prosecution team's own investigative files.

### System 6: 3501.xxx-xxx (Discovery References)

**5,023 pages across ~4,000 documents in DS9**

A litigation support reference number in the format `3501.045-008`. These appear alongside the `EFTA_` and `SDNY_` stamps on protective-order material. The `3501` prefix likely refers to a case or matter number in a document review platform (Relativity or Concordance). These documents are consistently marked `SUBJECT TO PROTECTIVE ORDER PARAGRAPHS 7, 8, 9, 10, 15, and 17` from the Maxwell case.
...
**Zero overlap exists between the R1 stream and the SDNY/bank streams.** No document carries both EFTA_R1_ and any of the other secondary stamps. These were independent processing pipelines that were merged at the final production stage.

## Combined Withholding Analysis

| System | Source | Pages Reviewed | Pages Released | Pages Withheld | Rate |
|--------|--------|---------------|----------------|----------------|------|
| EFTA_R1_ | FBI extractions | 2,214,161 | 969,970 | 1,271,798 | 57.4% |
| EFTA_ | SDNY production | 269,394 | 67,493 | 201,901 | 74.9% |
| **Total** | | **2,483,555** | **1,037,463** | **1,473,699** | **59.3%** |

1.47 million pages were reviewed and numbered but not included in the public production. This figure covers only the two systems where gap analysis is possible. The bank stamps (JPM-SDNY, DB-SDNY) and the SDNY_GM stamps do not lend themselves to the same gap analysis because we cannot determine their original production span.
...
The uniform distribution of R1 gaps is consistent with systematic review processes such as deduplication and privilege screening. The higher withholding rate in the SDNY production (74.9% vs 57.4%) may reflect the different nature of the material (investigative files vs. email) or different review criteria.
...
A small number of outlier values (154 R1 numbers above 3,000,000 and 105 EFTA_ numbers above 400,000) were excluded as likely OCR errors where extra digits were appended to the stamp. The core ranges (R1: 11-2,214,168; EFTA_: 0-269,393) contain 99.8% of all detected stamps and are internally consistent.
