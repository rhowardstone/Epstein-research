...
## Ranked by "Predator Name Reveal" Score
### Maximizing the number of predator names revealed per document viewed

**Date:** February 14, 2026
**Purpose:** Prioritize DOJ reading room time to maximize identification of redacted perpetrators
**Scoring:** `REVEAL_SCORE = estimated_redacted_names × crime_severity × novelty_factor`

- **crime_severity:** 3 = rape/CSAM/child trafficking, 2 = adult trafficking/assault, 1 = financial crime/complicity
- **novelty_factor:** 2.0 = name completely unknown, 1.5 = partially identified from context, 1.0 = already identified
- **estimated_redacted_names:** Count of likely person-name redactions per document

**Reading Room Rules:** No electronic devices. Handwritten notes only. Documents organized by EFTA number. Request unredacted versions.

---

## TOP 10: IF CONGRESS LOOKS AT NOTHING ELSE

These are the documents where the highest number of predator names will be revealed by viewing the unredacted version. Each document contains descriptions of serious crimes with perpetrator identities blacked out.

| Rank | EFTA | Score | Names | What It Is | What Gets Revealed |
|------|------|-------|-------|------------|-------------------|
...
## TOP 25: ONE AFTERNOON IN THE READING ROOM

Documents 11-25 contain specific violent crimes with redacted perpetrators, prosecution failures with unnamed decision-makers, or evidence that would identify previously unknown participants.
...
## FULL LIST: COMPLETE PRIORITIZED INDEX

### TIER A: PREDATOR NAME REVEALS (Score 20+)

Documents where unredacted viewing will directly reveal currently unknown perpetrator identities.

| # | EFTA | Score | Est. Names | Crime Type | What Gets Revealed |
|---|------|-------|-----------|------------|-------------------|
...
Documents with specific violent crimes described and at least one redacted perpetrator.
...
| 22 | EFTA00007741 | 6.0 | 0 | CSAM/surveillance | VHS surveillance tape contents — never viewed |
| 23 | EFTA00038382 | 6.0 | 1 | CSAM | Former staff video footage tipster identity |
...
| 32 | EFTA02730271 | 4.0 | 1 | Trafficking | Person of interest for Maxwell trial (FBI 2022) |
| 33 | EFTA02730477 | 4.0 | 1 | Trafficking | Second FBI tactical intelligence report (2022) |
| 34 | EFTA00027666 | 15.0 | 5 | Prosecution failure | All names granted immunity under NPA |
| 35 | EFTA02589110 | 2.0 | 1 | Intelligence | Whether Bill Burns (future CIA Director) attended |
| 36 | EFTA00016311 | 4.0 | 1 | Evidence destruction | Missing deposition — entire contents vanished |

### TIER C: PROSECUTION FAILURES AND FINANCIAL CRIMES (Score 1-4)

Documents that reveal systemic failures rather than specific perpetrator names, but still valuable for congressional inquiry.

| # | EFTA | Score | What Gets Revealed |
|---|------|-------|-------------------|
| 37 | EFTA02731576 | 3.0 | Verify victim's direct accusation to Black |
| 38 | EFTA02731578 | 3.0 | AUSA identity who declined Black prosecution |
| 39 | EFTA00029358 | 3.0 | Staley rape allegation — investigation outcome |
| 40 | EFTA02731577 | 2.0 | Brad Edwards retention terms by Black |
| 41 | EFTA00031495 | 3.0 | CBP officer identity — Badge #CAS03223 |
| 42 | EFTA01649190 | 9.0 | MCC DVR failure — who ordered/failed to install replacements |
| 43 | EFTA00027732 | 9.0 | 4chan death leak investigation — hard drives removed from SHU |
| 44 | EFTA00035225 | 4.0 | Suicide watch logs — who removed watch same day cameras failed |
| 45 | EFTA00019322 | 4.0 | Will executed 2 days before death — trust terms |
| 46 | EFTA00028149 | 2.0 | AG Barr split recusal — internal reasoning |
| 47 | EFTA00014372 | 4.0 | Richardson — who blocked prosecution |
| 48 | EFTA02731604 | 3.0 | Black investigation — why was it closed |
| 49 | EFTA02731583 | 3.0 | ADAs Wimmer/Puzio/Saxtein — parallel investigation details |
| 50 | EFTA00035812 | 6.0 | BOP employees — who failed on death night |

### TIER D: FINANCIAL ARCHITECTURE (Score 1-2)

Financial documents where names are mostly known but details illuminate the system.

| # | EFTA | What Gets Revealed |
|---|------|-------------------|
| 51 | EFTA00027019 | Complete $755M flow — all account numbers and beneficiaries |
| 52 | EFTA01359500 | Full Deutsche Bank officer roster |
| 53 | EFTA01362456 | "KYC is not happening" — author and recipient |
| 54 | EFTA01414241 | AML escalation — who ignored three requests |
| 55 | EFTA01431221 | $23M wire approval chain — all staff names |
| 56 | EFTA02730996 | Apollo/Dechert conflicts report — full details of $168M+ |
| 57 | EFTA02731023 | Senate Finance Committee — Black's non-responses |
| 58 | EFTA02664953 | "Liquidate the J BLACK trust" — full context |
| 59 | EFTA00015176 | $18.3M wire to Maxwell — source of funds |
| 60 | EFTA00023239 | $376M unexplained revenue — any new sourcing info |

### TIER E: EVIDENCE THAT SHOULD EXIST BUT DOESN'T

These aren't reading room documents per se — they're items Congress should demand be produced, searched, or declassified.

| # | EFTA | What Congress Should Demand |
|---|------|---------------------------|
| 61 | EFTA00015823 | **Federal warrant for 2005 computer forensic image.** From peak abuse period. Never searched. |
| 62 | EFTA00007741/7984/7987/7990 | **VHS surveillance tapes be scanned and reviewed.** Professional time-lapse recordings never viewed. |
| 63 | EFTA00027290 | **Separate warrant for Bannon-Epstein texts.** Found on phone, labeled "not responsive," never read. |
| 64 | EFTA00015219 | **Declassification of foreign government intelligence relationship.** |
| 65 | EFTA00038127 | **Image/video review results from October 2020 protocol.** Assigned to 10 devices. No results document exists. |
| 66 | EFTA00039019 | **Full accounting of CSAM found during 2023 estate settlement.** |
| 67 | EFTA00024797 | **Masseuse list be produced unredacted to congressional committee.** 7 pages planned as Maxwell trial exhibit. |
| 68 | EFTA01731006 | **FBI blackmail investigation findings be declassified.** Case serial 31E-MM-108062. |

### TIER F: AUTOMATED SCORING DISCOVERIES

The automated scorer (crime keywords × redaction density across 24,982 documents) identified several high-value documents not previously in the investigation reports. After manual verification, these are the genuine finds:

| # | EFTA | Pages | What Automated Analysis Found | Reading Room Value |
|---|------|-------|------------------------------|-------------------|
| 69 | EFTA01727588 | 100 | FBI FD-302 victim interviews from 2006-2008. 783 redactions. Victims name who recruited them, who brought them to Epstein's house. Redacted names include recruiters/facilitators, not just victims. | **HIGH** — full recruitment network |
| 70 | EFTA00230786 | 1,131 | Master SDFL case file. NPA correspondence with defense team, victim depositions, phone record analysis linking Epstein to victims and facilitators. | **HIGH** — most comprehensive single file |
| 71 | EFTA01625916 | 102 | SDNY search warrant affidavit for 62+ electronic devices. FBI affidavit describes photos of Maxwell with 16-22yo females. References Individual-1 through Individual-3. | **HIGH** — device evidence details |
| 72 | EFTA00041963 | 1,000 | BOP internal emails + psychological reconstruction of death. Documents cellmate removal, staff failures, video confiscated by FBI. | **HIGH** — death chain of command |
| 73 | EFTA01688396 | 100 | Original FBI evidence inventory + PBPD probable cause affidavit. Message slips with initials (C.J., M., P.S., A., J.L., T.) — may identify contacts. | **MEDIUM** — evidence inventory |
| 74 | EFTA01711951 | 100 | Jail call records for 917-855-3363 during 2008 incarceration. Who was Epstein calling from jail? | **MEDIUM** — call recipient identity |

**Documents incorrectly scored high (false positives):**
- EFTA01723652 (victim notification letters — boilerplate DOJ forms, redacted names are *victims* not perpetrators)
- EFTA01412453 (LexisNexis report of public news articles)
- EFTA01661603 (Awareness Center public web content)
- EFTA01728716 (DOJ training manual on child exploitation — generic, no case-specific info)
- EFTA01682136 (Palm Beach Post newspaper clippings)

---

## CROSS-REFERENCE: DOCUMENTS BY PERPETRATOR

For congressional members focused on specific individuals, these are the documents that would reveal the most about each:

### Leon Black (4+ victims, $62.5M settlement, no charges)
| Priority | EFTA | What It Reveals |
|----------|------|-----------------|
| 1st | EFTA02731488 | Names of 25 men victim was trafficked to |
| 2nd | EFTA02731515 | Identity of 6 men in hotel/video allegation |
| 3rd | EFTA02731721 | Full Wigdor letter — all named perpetrators |
| 4th | EFTA02731648 | Attorney representing 10 victims |
| 5th | EFTA02731578 | Which AUSA declined to prosecute |

### Unknown Predators (names completely hidden)
| Priority | EFTA | What It Reveals |
|----------|------|-----------------|
...
| Priority | EFTA | What It Reveals |
|----------|------|-----------------|
| 1st | EFTA00015219 | Which foreign government |
| 2nd | EFTA00037218 | "Certain parties" identity |
| 3rd | EFTA00009116 | Acosta's classified information reference |
| 4th | EFTA02589110 | Whether CIA Director attended |

### Evidence Destruction/Institutional Failure
| Priority | EFTA | What It Reveals |
|----------|------|-----------------|
| 1st | EFTA00015823 | 2005 computer — demand warrant |
| 2nd | EFTA00007741 | VHS tapes — demand scanning |
| 3rd | EFTA00038127 | Missing review results — demand production |
| 4th | EFTA01649190 | DVR failure — who was responsible |
...
### Data Sources
- **full_text_corpus.db:** 1,380,941 documents, 2,731,825 pages, FTS5 indexed
- **redaction_analysis_v2.db:** 2,587,102 redactions, 49,153 name-type entities
- **10+ investigation reports** with 400+ key EFTA citations
- **CONGRESS_RAW_EFTA_LIST.md:** 250+ EFTAs categorized by crime type
- **CONGRESSIONAL_READING_GUIDE.md:** Tiered reading list with specific instructions

### Automated Scoring (Layer 1)
- FTS5 search identified 83,567 crime-keyword pages across 24,982 documents
- Redaction density joined from 874,208 page-level redaction records
- Name-proximity patterns (Mr./Ms./Dr. + redaction, "trafficked to," "raped by," etc.)
- Document-level aggregation: crime pages × crime severity × redaction density

### Manual Enrichment (Layer 2)
- 111 EFTAs manually enriched with crime context, redacted name estimates, and novelty factors
- Sources: 10 investigation sessions, 70+ reports, 400+ EFTA citations
- Each enriched EFTA includes: description, crime keywords, estimated redacted names, severity, novelty, source reports

### Final Scoring (Layer 3)
```
REVEAL_SCORE = estimated_redacted_names × crime_severity × novelty_factor
```
- Enrichment values override automated estimates when available
- Automated score provides 10% boost for documents also flagged by keyword/redaction analysis
- Documents with both high crime severity AND high redaction density receive 20% bonus

### Important Caveats
1. **DS9-11 redaction data is unreliable** — "recovered text" from these datasets is garbled OCR of baked-in redaction bars, not actual hidden content
2. **Name entity counts from extracted_entities are 95%+ noise** — used only for density scoring, not name identification
3. **Enrichment is the primary signal** — automated scoring alone produces bulk legal documents at the top due to page-count bias
4. **Victim privacy** — no real victim names, pseudonym-to-name mappings, or identifying details appear in this document
...
*Generated from forensic analysis of 218GB DOJ Epstein file release (DataSets 1-12)*
*Scoring tool: tools/congressional_scorer.py*
*Enrichment data: efta_enrichment.json (111 manually-verified EFTAs)*
*Automated analysis: 24,982 documents scored against crime keywords and redaction density*
