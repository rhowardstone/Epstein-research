...
**Reference:** DATA_QUALITY_AUDIT.md (616,233 bad_overlay records; ~98% OCR noise; ~500 clearly substantive)
...
### 5. BIOTECH_SCIENCE_NETWORK_INVESTIGATION.md
...
### 6. SHELL_ENTITY_DARK_MONEY_INVESTIGATION.md
...
### 7. POWER_OVERLAP_SEALED_FILINGS_INVESTIGATION.md
...
### 8. FINAL_INVESTIGATION_REPORT.md
...
This is the single most problematic sentence in the entire investigation. It implies that 1.8 million pieces of hidden text were successfully extracted from behind redaction boxes. The DATA_QUALITY_AUDIT.md definitively shows that:
...
These 12 are correctly described in the PLIST_REDACTED_EMAILS_DEEP_DIVE.md report and accurately cited in the FINAL_INVESTIGATION_REPORT. They represent genuine redaction failures, not OCR noise.
...
1. **The 616,233 bad_overlay record count** -- should NOT be cited as "616,233 pieces of recovered hidden text." DATA_QUALITY_AUDIT.md confirms ~98% is OCR noise.
...
- **ZERO findings** would be invalidated by the DATA_QUALITY_AUDIT.md conclusions
...
3. Add the DATA_QUALITY_AUDIT.md context wherever bad_overlay statistics are reported
...
*This audit was conducted by reading the first 100-300 lines of each report, searching each report for bad_overlay/hidden-text terminology, cross-referencing evidence citations against the DATA_QUALITY_AUDIT.md findings, and examining the actual evidence types underlying each major claim.*
