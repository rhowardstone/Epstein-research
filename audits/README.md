...
2. Key claims are verified against source EFTA documents using SQL queries against [`full_text_corpus.db`](https://github.com/rhowardstone/Epstein-research-data/releases/tag/v5.0) (1.38M documents, 2.73M pages extracted from all 12 DOJ datasets)
